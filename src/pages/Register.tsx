...
const Register = () => {
  ...
  const { register, googleLogin, linkedinLogin, isLoading } = useAuth();
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="mentee" className="cursor-pointer">Student/Mentee</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="mentor" id="mentor" />
                  <Label htmlFor="mentor" className="cursor-pointer">Alumni/Mentor</Label>
                </div>
              </RadioGroup>
            </div>
